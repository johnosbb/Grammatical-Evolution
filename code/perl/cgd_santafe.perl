...
print OUT   "plot  [] [0:88] \"$ARGV[0]\"  using 3 title 'Selected Path' with lines lt 0\n";
print OUT   "replot   \"$ARGV[0]\"  using 5 title 'Explored Path' with lines lt 2\n";
print OUT "pause -1\n";
print OUT "set terminal png small color\n";
print OUT "set out \"testfile.cfg.capture.png\"\n";
print OUT "replot\n";
print OUT "set terminal fig small landscape\n";
print OUT "set out \"testfile.cfg.capture.fig\"\n";
print OUT "replot\n";
close(IN);
close(OUT);
