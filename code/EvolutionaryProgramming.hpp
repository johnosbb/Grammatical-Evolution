#ifndef EvolutionaryProgramming_h
#define EvolutionaryProgramming_h 1
...
//	generated.
class EvolutionaryProgramming : public Metaheuristic
{

public:
  EvolutionaryProgramming();
  
  EvolutionaryProgramming(const EvolutionaryProgramming &right);
  
  virtual ~EvolutionaryProgramming();
